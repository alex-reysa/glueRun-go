...
Updated: 2026-07-10T22:58:08Z
Run: `ORIGIN-20260710T225807Z-95909`
Mode: `apply`
Current branch: `agent/integration`
Target branch: `agent/integration`
Head: `df4d35d`
Tracked/untracked status entries: 3
Git worktrees: 4
Inbox packets: 1
...
- Dry-run validates inbox packet shape and writes this snapshot to `.gluerun-state/runs/ORIGIN-20260710T225807Z-95909/reconcile-snapshot.md`.
