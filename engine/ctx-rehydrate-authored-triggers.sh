...
# deliverable. TASK-0059 (gluerun_ctx_rehydrate_authored_eligible) matches each
...
# and does NOT gate the node. GLUERUN_CTX_MANIFEST (default 0) still gates the
# feature end to end; this leaf is inert until the follow-up wire-in feeds its
# output to gluerun_ctx_rehydrate_authored_config_render /
